...
exe:	pet_fera_main.o	pet_fera_corpo.o pet_fera_pesquisar.o pet_fera_cadastrar.o pet_fera_carregamento.o pet_fera_editar.o pet_fera_remover.o	pet_fera_consulta_p_func.o pet_fera_checagem.o
	g++	-o	exe	-Wall	-ansi	-pedantic	-pg  pet_fera_main.o pet_fera_corpo.o pet_fera_pesquisar.o pet_fera_cadastrar.o pet_fera_carregamento.o pet_fera_editar.o pet_fera_remover.o pet_fera_consulta_p_func.o pet_fera_checagem.o -std=c++11
...
pet_fera_pesquisar.o:	pet_fera_pesquisar.cpp pet_fera.h
	g++	-Wall	-ansi	-pedantic	-g	-O0	-pg	-c	pet_fera_pesquisar.cpp		-std=c++11

pet_fera_cadastrar.o:	pet_fera_cadastrar.cpp pet_fera.h
	g++	-Wall	-ansi	-pedantic	-g	-O0	-pg	-c	pet_fera_cadastrar.cpp		-std=c++11

pet_fera_carregamento.o:	pet_fera_carregamento.cpp pet_fera.h
	g++	-Wall	-ansi	-pedantic	-g	-O0	-pg	-c	pet_fera_carregamento.cpp	-std=c++11

pet_fera_editar.o:	pet_fera_editar.cpp pet_fera.h
	g++	-Wall	-ansi	-pedantic	-g	-O0	-pg	-c	pet_fera_editar.cpp		-std=c++11

pet_fera_remover.o:	pet_fera_remover.cpp pet_fera.h
	g++	-Wall	-ansi	-pedantic	-g	-O0	-pg	-c	pet_fera_remover.cpp		-std=c++11
