...
exe:	pet_fera_main.o	pet_fera_corpo.o pet_fera_pesquisar.o pet_fera_cadastrar.o pet_fera_carregamento.o pet_fera_editar.o pet_fera_remover.o	
	g++	-o	exe	-Wall	-ansi	-pedantic	-pg	pet_fera_main.o	pet_fera_corpo.o pet_fera_pesquisar.o pet_fera_cadastrar.o pet_fera_carregamento.o pet_fera_editar.o pet_fera_remover.o	-std=c++11
